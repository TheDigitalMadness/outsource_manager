...
class Files:
    ...
    START_SELL_PDF: str = os.path.join(BASE_FILES_DIR, "Начало_продаж_в_торговую_сеть.pdf")
    CASES_PDFS: tuple = (
        os.path.join(BASE_FILES_DIR, "Кейс_1.pdf"),
        os.path.join(BASE_FILES_DIR, "Кейс_2.pdf"),
        os.path.join(BASE_FILES_DIR, "Кейс_3.pdf"),
        os.path.join(BASE_FILES_DIR, "Кейс_4.pdf"),
        os.path.join(BASE_FILES_DIR, "Кейс_5.pdf"),
    )